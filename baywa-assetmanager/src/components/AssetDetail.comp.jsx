    ...
    <>
      ...
      <div className="info-container">
        ...
        <p className="info-text">
          ...
          voluptate ab! In, dolorem iure illo culpa optio beatae voluptatum, rem
          fuga consectetur itaque cumque, tenetur officia quaerat. Voluptate
          labore, beatae asperiores quos fugit voluptatem!
        </p>
      </div>
    </>
  );
